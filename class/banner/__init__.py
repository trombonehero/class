...
@click.option('--credential-file', help='username/password file (YAML format)',
              default='credentials.yaml', show_default=True)
@click.option('--term', help='e.g., 201601 for Fall 2016',
              default=term, show_default=True)
def cli(banner_root, ca_bunde, credential_file, term):
